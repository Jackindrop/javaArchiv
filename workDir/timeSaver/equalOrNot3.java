...
public class equalOrNot3 {
    ...
    public static void optionsOfGift() {
        ...
        System.out.print("|       |");
        for (int i= 0; i<= 48-nEins.length()/2; i++) { // 1
            System.out.print(" ");
        }
        System.out.print(nEins);
        for (int i= 0; i<= 49-nEins.length()/2; i++) { 
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nZwei.length()/2; i++) { // 2
            System.out.print(" ");
        }
        System.out.print(nZwei);
        for (int i= 0; i<= 49-nZwei.length()/2; i++) { 
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nDrei.length()/2; i++) { // 3
            System.out.print(" ");
        }
        System.out.print(nDrei);
        for (int i= 0; i<= 48-nDrei.length()/2; i++) {
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nVier.length()/2; i++) { // 4
            System.out.print(" ");
        }
        System.out.print(nVier);
        for (int i= 0; i<= 49-nVier.length()/2; i++) {
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nFunf.length()/2; i++) { // 5
            System.out.print(" ");
        }
        System.out.print(nFunf);
        for (int i= 0; i<= 48-nFunf.length()/2; i++) {
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nSechs.length()/2; i++) { // 6
            System.out.print(" ");
        }
        System.out.print(nSechs);
        for (int i= 0; i<= 48-nSechs.length()/2; i++) {
            System.out.print(" ");
        }
        System.out.print("|        |\n|       |");
        
        for (int i= 0; i<= 48-nNull.length()/2; i++) { // 0
            System.out.print(" ");
        }
        System.out.print(nNull);
        for (int i= 0; i<= 49-nNull.length()/2; i++) {
            System.out.print(" ");
        }
        ...
        for (String key : data.keySet()) {
            ...
            for (int i= 0; i<= datenTabelle.size(); i++) {
                if (i == 0) {
                    ...
                    for (int k= 0; k<= 34-keyToPrint.length(); k++) {
                        System.out.print("-");
                    }
                    System.out.print("|"+datenTabelle.get(i)+splitter[i]);
                    for (int k= 0; k<= 56-datenTabelle.get(i).length()-splitter[i].length(); k++) {
                        System.out.print(" ");
                    }
                ...
                System.out.print("|       |\t\t\t\t\t\t\t\t "+datenTabelle.get(i-1) +splitter[i]+"|");
                    for (int k= 0; k<= 33-datenTabelle.get(i-1).length()-splitter[i].length(); k++) {
                        System.out.print("-");
                    }
                    System.out.print("|        |\n");
                }
    ...
    public static void headRow(String title, String info, boolean roler) {
        ...
        if ((title.equals("empty"))&&(info.equals("empty"))) {
            System.out.print("|       |");
            for (int i= 0; i<= 108-title.length()-info.length(); i++) {
                System.out.print(" ");
            }
            System.out.print("|        |");
            System.out.println();
