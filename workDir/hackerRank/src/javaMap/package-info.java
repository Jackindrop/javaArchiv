 ...
 * - Java Map
 *
 * You are given a phone book that consists of people's names and
 * their phone number. After that you will be given some person's
 * name as query. For each query, print the phone number
 * of that person.
 *
 * Input Format
 *
 * The first line will have an integer  denoting the number of
 * entries in the phone book. Each entry consists of two lines:
 ...
 * in the editor. You can either complete that code or write
