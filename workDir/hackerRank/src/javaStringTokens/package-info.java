 ...
 *  We define a token to be one or more consecutive English
 *  alphabetic letters. Then, print the number of tokens,
 *  followed by each token on a new line.
 *
 * Note: You may find the String.split method helpful in
 ...
 *  letters, blank spaces, exclamation points (!), commas (,),
 *  question marks (?), periods (.), underscores (_),
 ...
 * characters. There are a total of  such tokens in string ,
 * and each token is printed in the same order in which
