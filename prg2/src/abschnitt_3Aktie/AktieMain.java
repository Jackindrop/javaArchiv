...
public class AktieMain {
    public static void main(String[] args) {
        ...
        if (gewinn1 > gewinn2) {
            System.out.println(aktie1.getIsin() + " war rentabler als "
                    + aktie2.getIsin() + ".");
        } else if (gewinn2 > gewinn1) {
            System.out.println(aktie2.getIsin() + " war rentabler als "
                    + aktie1.getIsin() + ".");
        } else {            // gewinn1== gewinn2
            System.out.println("Wie viele Käufe haben Sie getätigt= ");
        }
    }
