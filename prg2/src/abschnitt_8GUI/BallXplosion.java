...
public class BallXplosion extends Application {
    ...
    private static final double MAX_SPEED = 1600 ;
    private static final Color[] COLORS = new Color[] { RED, YELLOW, GREEN,
            BROWN, BLUE, PINK, BLACK, PURPLE, GRAY, GREENYELLOW,
            LIGHTGOLDENRODYELLOW, ROSYBROWN, ORANGE, ORANGERED};
    ...
    public void start(Stage primaryStage) {
        ...
        ballContainer.addEventHandler(MouseEvent.MOUSE_CLICKED,
                event -> {
                    if (event.getClickCount() == 2) {
                        balls.clear();
                        createBalls(NUM_BALLS, MIN_RADIUS, MAX_RADIUS, MIN_SPEED,
                                MAX_SPEED, ballContainer.getWidth()/2,
        ...
        createBalls(NUM_BALLS, MIN_RADIUS, MAX_RADIUS, MIN_SPEED, MAX_SPEED, 1280, 540);
  //      createBalls(NUM_BALLS, MIN_RADIUS, MAX_RADIUS, MIN_SPEED, MAX_SPEED, 450, 700);
        ...
        final Scene scene = new Scene(root, 2560, 1080);
 //       final Scene scene = new Scene(root, 900, 1400);
